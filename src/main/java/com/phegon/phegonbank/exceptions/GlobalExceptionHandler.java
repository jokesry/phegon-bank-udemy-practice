...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Response<?>> handleInsufficientBalanceException(Exception ex){
        Response<?> response = Response.builder()
    ...
    public ResponseEntity<Response<?>> handleInvalidTransactionException(Exception ex){
        Response<?> response = Response.builder()
                .statusCode(HttpStatus.BAD_REQUEST.value())
                .message(ex.getMessage())
                .build();
